...
const CHUNK_SIZE = parseInt(__ENV.CHUNK_SIZE || "10", 10);

export const options = buildOptions("grpc-stream-small");
...
export default function () {
    ...
    const stream = new grpc.Stream(client, "bench.payload.PayloadService/StreamSmall");
